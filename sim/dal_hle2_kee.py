...
class LocalizationNode:
    ...
    def init_figure(self):
        ...
        if self.args.figure == True:# and self.obj_fig==None:
            ...
            self.ax_lik_high =  plt.subplot(self.gridspec[1,2])            
            self.ax_gtl =  plt.subplot(self.gridspec[2,1])
            self.ax_gtl_high =  plt.subplot(self.gridspec[2,2])            


            self.ax_pbel =  plt.subplot(self.gridspec[0,3])
            self.ax_plik =  plt.subplot(self.gridspec[1,3])
            self.ax_pbel_high =  plt.subplot(self.gridspec[0,4])
            self.ax_plik_high =  plt.subplot(self.gridspec[1,4])
            self.ax_pgtl =  plt.subplot(self.gridspec[2,3])
            self.ax_pgtl_high =  plt.subplot(self.gridspec[2,4])
